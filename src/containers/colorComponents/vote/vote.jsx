          ...
          <div className="tm-form-group__field">
            <div className="tx">
              ...
              <div className="tx__content">
                ...
                >
                  <div className="tx__content__caption" style={{ color: 'black' }}>
                    <p>Voted&nbsp;{latestSignReq.msgs[0].value.option}</p>
                  </div>
                  <div className="tx__content__information">
                    On&nbsp;
                  <a className="">Proposal #{latestSignReq.msgs[0].value.proposal_id}</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="session-approve-footer">
              <button className="button left-button secondary" id="reject-btn" onClick={() => reject()}>
                Reject
              </button>
              <button className="button right-button" id="approve-btn" onClick={(e) =>
                vote(
